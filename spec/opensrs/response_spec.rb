describe OpenSRS::Response do
  ...
  context "#errors" do
    ...
    it "should return nil for successful responses" do
    ...
    it "should return a formatted error message and code" do
    ...
    it "should return 'Unknown error' if no error code is available" do
    ...
    it "should return 'Unknown error' if no error text is available" do
